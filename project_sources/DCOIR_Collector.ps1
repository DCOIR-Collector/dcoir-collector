  ...
  if (@($findings).Count -gt 0) {
    foreach ($finding in ($findings | Select-Object -First 10)) {
      ...
      if ($finding.ExecutablePath) {
        ...
        Add-Recommendation ('Suggested next action: powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\DCOIR_Collector.ps1" -Mode Enrich -RunId {0} -Action SigcheckPath -Path "{1}" -OutRoot {2}' -f $State.RunId, $safePath, $OutRoot)
        Add-Recommendation ('Suggested next action: powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\DCOIR_Collector.ps1" -Mode Enrich -RunId {0} -Action StringsPath -Path "{1}" -OutRoot {2}' -f $State.RunId, $safePath, $OutRoot)
        Add-Recommendation ('Suggested next action: powershell.exe -NoProfile -ExecutionPolicy Bypass -File ".\DCOIR_Collector.ps1" -Mode Enrich -RunId {0} -Action PullSuspiciousFile -Path "{1}" -OutRoot {2}' -f $State.RunId, $safePath, $OutRoot)
      }
    }
  } else {
...
function Get-QuickUsageText {
  return @(
    ...
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick collect-t1"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick collect-t2"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-tcp"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-tcp"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-logtext -Target Security"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-logtext -Target Security"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-lograw -Target Security"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-lograw -Target Security"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-sigcheck -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-sigcheck -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-listdlls -Target 1234"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-listdlls -Target 1234"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-access-file -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-access-file -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-access-service -Target EventLog"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-access-service -Target EventLog"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-access-reg -Target HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-access-reg -Target HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-strings -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-strings -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-streams -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-streams -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-pull-file -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-pull-file -Target C:\Windows\System32\notepad.exe"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-pull-script -Target C:\Temp\sample.ps1"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-pull-script -Target C:\Temp\sample.ps1"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-pull-task -Target \Microsoft\Windows\Defrag\ScheduledDefrag"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-pull-task -Target \Microsoft\Windows\Defrag\ScheduledDefrag"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-pull-service -Target EventLog"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-pull-service -Target EventLog"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-pull-wmi-file -Target C:\Temp\sample.ps1"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-pull-wmi-file -Target C:\Temp\sample.ps1"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-finalize"
    "  powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick cleanup"
  ) -join [Environment]::NewLine
}
...
function Write-QuickNextSteps {
  ...
  switch ($Phase) {
    "Collect" {
      Write-Output '1. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-tcp" --comment "Run DCOIR TCP enrichment"'
      Write-Output '2. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-start-lograw -Target Security" --comment "Run DCOIR raw Security log enrichment"'
      Write-Output '3. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick cleanup" --comment "Running Cleanup on DCOIR_Collector"'
    }
    "EnrichOpen" {
      Write-Output '1. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-add-logtext -Target Security" --comment "Add Security log text enrichment to current DCOIR session"'
      Write-Output '2. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick enrich-finalize" --comment "Finalize current DCOIR enrichment session"'
    }
    "EnrichFinalized" {
      Write-Output '1. Retrieve the enrich bundle with the NEXT_GET_FILE command shown above'
      Write-Output '2. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick cleanup" --comment "Running Cleanup on DCOIR_Collector"'
    }
    "Cleanup" {
      Write-Output '1. Local script file remains in place by design'
      Write-Output '2. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick collect-t1" --comment "Run DCOIR collect T1"'
      Write-Output '3. execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick collect-t2" --comment "Run DCOIR collect T2"'
    }
  }
}
...
try {
  ...
  switch ($Mode) {
    "Collect" {
      ...
      Write-Output ('CLEANUP_COMMAND=execute --command "powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\DCOIR_Collector.ps1 -Quick cleanup" --comment "Running Cleanup on DCOIR_Collector"')
      Write-Output ('DELETE_SCRIPT_COMMAND=execute --command "cmd.exe /c del /f /q DCOIR_Collector.ps1" --comment "Remove uploaded DCOIR_Collector script"')
