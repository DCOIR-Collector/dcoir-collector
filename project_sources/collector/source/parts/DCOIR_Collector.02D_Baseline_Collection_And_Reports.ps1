<#
.SYNOPSIS
DCOIR collector baseline and metadata report writers.

.DESCRIPTION
Builds the main baseline artifact set, analyst follow-up queue, metadata report, and report-file write helper.
...
.OUTPUTS
Baseline report structures, metadata report text, and written report-file paths.
#>
