...
SHARED_CONTRACT_FILES = [
    ...
    Path("project_sources/github_actions/tools/lib/audit_reusable_contract_helpers.py"),
    Path("project_sources/github_actions/tools/lib/audit_reusable_contract_checks.py"),
    Path("project_sources/github_actions/tools/lib/audit_reusable_contract_runner.py"),
