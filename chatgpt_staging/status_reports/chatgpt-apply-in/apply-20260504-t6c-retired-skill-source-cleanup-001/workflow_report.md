...
- result: failure
- phase: apply-in
- request_id: apply-20260504-t6c-retired-skill-source-cleanup-001
- payload_path: chatgpt_staging/in/apply-20260504-t6c-retired-skill-source-cleanup-001/payload.zip.b64
- github_run_id: 25319579366
- github_ref: refs/heads/main
- github_sha: 189d4b4c574857a7a28b8a6562d72048a8e52985
- artifact_name: chatgpt-apply-in-failure-25319579366
- artifact_retention_days: 7
- report_created_utc: 2026-05-04T12:41:50Z
...
```json
{
  ...
  "deletes": [
    {
      "path": "dcoir_skills/dcoir-plan-tracker",
      "recursive": true,
      "require_exists": true
    },
    {
      "path": "dcoir_skills/dcoir-attention-signaler",
      "recursive": true,
      "require_exists": true
    }
  ]
...
Detailed diagnostics, hashes, and any copied manifest are uploaded as GitHub Actions artifact 'chatgpt-apply-in-failure-25319579366' for run 25319579366 when available.

## Cleanup guidance

After ChatGPT reads this report and retrieves any needed artifact/log details, create a cleanup marker for request id 'apply-20260504-t6c-retired-skill-source-cleanup-001' with cleanup_status_reports=true and cleanup_in_payloads=true.
