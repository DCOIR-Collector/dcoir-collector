...
- result: failure
- phase: apply-in
- request_id: apply-20260504-t6d-session-manager-source-create-002
- payload_path: chatgpt_staging/in/apply-20260504-t6d-session-manager-source-create-002/payload.zip.b64
- github_run_id: 25327358402
- github_ref: refs/heads/main
- github_sha: ef28941ac9f8c31d8d78830b844847a0985fe89b
- artifact_name: chatgpt-apply-in-failure-25327358402
- artifact_retention_days: 7
- report_created_utc: 2026-05-04T15:19:17Z
...
Detailed diagnostics, hashes, and any copied manifest are uploaded as GitHub Actions artifact 'chatgpt-apply-in-failure-25327358402' for run 25327358402 when available.

## Cleanup guidance

After ChatGPT reads this report and retrieves any needed artifact/log details, create a cleanup marker for request id 'apply-20260504-t6d-session-manager-source-create-002' with cleanup_status_reports=true and cleanup_in_payloads=true.
