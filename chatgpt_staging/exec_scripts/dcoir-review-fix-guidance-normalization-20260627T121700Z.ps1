...
'@ | Set-Content -LiteralPath $patchPath -Encoding UTF8
    ...
    Invoke-Native -FilePath 'git' -ArgumentList @('status', '--short', '--', 'scripts/openrouter_pr_review.py', 'scripts/openrouter_pr_review_pareto_context.py', 'scripts/openrouter_pr_review_pareto_context_selftest.py')
