...
$requestId = 'exec-20260619-pr281-escaped-quoted-auth-redaction-005'
...
try {
    ...
    if ($selftestText.Contains('hdeader_quoted_secret')) {
        $fixedSelftestText = $selftestText.Replace('hdeader_quoted_secret', 'header_quoted_secret')
        $utf8NoBom = New-Object System.Text.UTF8Encoding($false)
        [System.IO.File]::WriteAllText($selftestPath, $fixedSelftestText, $utf8NoBom)
    }
