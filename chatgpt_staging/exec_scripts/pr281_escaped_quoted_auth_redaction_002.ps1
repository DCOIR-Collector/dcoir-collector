...
$requestId = 'exec-20260619-pr281-escaped-quoted-auth-redaction-002'
$payloadB64 = Join-Path $repo 'chatgpt_staging/exec_payloads/pr281_escaped_quoted_auth_redaction_patch_001.py.b64'
