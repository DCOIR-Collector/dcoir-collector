...
Start here for ChatGPT workflow status and output handling.

Recommended new-session read order:

1. `workflow_status_output_quickstart.md`
2. `workflow_lanes_index.md`
3. `../HEARTBEAT_AND_ARTIFACT_READBACK.md`
