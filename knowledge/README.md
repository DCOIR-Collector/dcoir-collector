...
- `knowledge/DCOIR_Helper_Skills_Routing_Note.md` — descriptive current helper-skill routing aid
...
- `knowledge/comparative_reference_agent_markdowns/` — comparative readable reference set
- `knowledge/generated_agent_markdowns/` — generated readable agent markdown set
