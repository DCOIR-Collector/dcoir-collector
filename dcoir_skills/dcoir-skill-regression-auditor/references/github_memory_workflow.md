...
- Skill-regression folder: `dcoir_skill_memory/dcoir-skill-regression-auditor/`
- Default state file: `dcoir_skill_memory/dcoir-skill-regression-auditor/skill_regression_memory.md`
