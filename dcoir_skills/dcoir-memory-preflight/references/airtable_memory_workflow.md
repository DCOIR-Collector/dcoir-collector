<!-- skill-marker: updated-skill|20260425T071800Z|T2.3-airtable-first-skill-repair|source-update|dcoir-memory-preflight|airtable_memory_workflow.md -->
...
## Live memory target
- Query `dcoir-memory-preflight` when it exists.
