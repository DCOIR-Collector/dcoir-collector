...
Purpose: repo-surface classification, package hygiene, source-role context, and GitHub Desktop bundle context.
## Cache scope rule
...
- `Admin Registry` (`tblFaJW1V2DPc9css`): read live only when package decisions need admin/object-state or operator-tool context.
- `Operator Tools Registry` (`tblF1SCJBHRFUhpzi`): read live only when package decisions need admin/object-state or operator-tool context.
