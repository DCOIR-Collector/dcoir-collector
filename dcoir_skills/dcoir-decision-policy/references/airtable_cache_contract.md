# Airtable Cache Contract for dcoir-decision-policy

Purpose: decision overlays, authority/hard-stop rules, operator preference application, cleanup policy, and source-role drift gates.

## Designated Airtable tables

### dcoir-decision-policy
- Table id/source: `tblKHVXq16Xd5I31m`
- Required cached fields when present: decision_entry_id, approved_rule, situational_rule, workflow_impact, packaging_impact, source_basis, last_confirmed_text, status, retention_class, decision_family, updated_at

### Operator Preferences
- Table id/source: `tblnxZ3eLPT3W38wl`
- Required cached fields when present: preference_key, preference_statement, effective_behavior, status, scope, retention_class, notes, last_confirmed_text, updated_at
