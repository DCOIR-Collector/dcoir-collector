<!-- skill-marker: updated-skill|20260425T071800Z|T2.3-airtable-first-skill-repair|source-update|dcoir-decision-policy|airtable_memory_workflow.md -->
...
## Live memory target
- Query `dcoir-decision-policy` when it exists.
