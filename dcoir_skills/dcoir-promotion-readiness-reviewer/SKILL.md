...
description: review whether an africom_soc_ir / dcoir project change is ready, ready with conditions, or not ready after changed set and packaging posture are known.
---
<!-- skill-marker: updated-skill|20260429T171500Z|airtable-operational-schema-alignment|source-update|dcoir-promotion-readiness-reviewer|SKILL.md -->
