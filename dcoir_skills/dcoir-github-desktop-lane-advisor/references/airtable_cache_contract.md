# Airtable Cache Contract for dcoir-github-desktop-lane-advisor

Purpose: operator-tool discovery, local GitHub Desktop lane selection, launcher guidance, and reusable tool registry upkeep.

## Designated Airtable tables

### Operator Tools Registry
- Table id/source: `tblF1SCJBHRFUhpzi`
- Required cached fields when present: tool_id, tool_name, tool_family, repo_path, trigger_conditions, input_contract, output_contract, safety_preconditions, launcher_command, status, version_or_hash, last_validated_at, active, retention_class, updated_at, notes

### Local Configuration Registry
- Table id/source: `tblcJxCoYGpEda0FM`
- Required cached fields when present: config_name, purpose, reference_powershell, reference_cmd, reference_python, sensitive_value, safe_to_display, confirmed_present, config_kind, status, notes

### Admin Registry
- Table id/source: `tblFaJW1V2DPc9css`
- Required cached fields when present: registry_key, object_name, object_type, status, retention_class, notes, last_reviewed_at, updated_at
