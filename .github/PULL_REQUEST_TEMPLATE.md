...
- [ ] OpenRouter internal review (`/or-review` or `/dcoir-review`) is clear after Codi and before external Codex review, or explicitly not applicable
...
- [ ] OpenRouter internal review is clear on the latest PR head, including command comment, progress/readback, review output, and finding disposition
