...
- When `project_sources/CP-01_DCOIR_Version_Manifest.txt` and `project_sources/CP-02_DCOIR_Change_Log.txt` are present and marked current, read CP-01 first and CP-02 second for current-state claims.
