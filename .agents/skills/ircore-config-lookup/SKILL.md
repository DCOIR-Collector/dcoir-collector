...
- identify whether the OpenRouter internal review command gate (`/or-review` or `/dcoir-review`) applies between Codi clearance and the external `@codex` request, and report its workflow/readback requirements
...
- do not skip OpenRouter internal review gate lookup when PR review-gate sequencing is in scope
